...
import { Question } from '../../../core/models/survey_CJ';
...
const Questionnaire_CJ: React.FC<IQuestion> = ({
    q_id,
    question,
                ...
                <>
                {
                    question?.options?.map((item, opt_id) => (
                        <div key={item.key} className='field-radiobutton mb10 d-flex-default'>
                            ...
                            <InputText className='mr10 ml10' placeholder='옵션' value={item.optCon} 
                                        onChange={(e) => updateOption(q_id, opt_id, item.key, 'optCon', e.target.value)} />
...
export default Questionnaire_CJ;